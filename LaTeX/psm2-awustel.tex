...
%thesis info
\title{Antaramuka Web Untuk Sistem Terbenam Linux}      %thesis/dissertation/project report/repot title
\author{Muhammad Fauzilkamil Bin Zainuddin}             %The author
\degree{Ijazah Sarjana Muda Sains Komputer}             %The official degree title, e.g., Bachelor in Electrical Engineerig
